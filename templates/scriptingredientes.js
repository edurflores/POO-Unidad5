...
btnAgregar.addEventListener('click', e => {
    ...
    div.innerHTML = `<label>${total++}</label> - <label>${total++}</label> - <input type="text" name="Nombre" placeholder="Nombre" required> <input type="number" name="cantidad" placeholder="Cantidad" required> <input type="text" name="unimedida" placeholder="unidad de medida" required> <button onclick="eliminar(this)">Eliminar</button>`;
